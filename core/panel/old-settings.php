...
function devlyCreateSettingsPage() {
	...
	$settings_page = add_menu_page('Visualyze', 'Visualyze', 'edit_theme_options', 'theme-settings', 'devlyBuildSettingsPage' );
...
function devlyThemeSubmitButton() {
	...
	$saveSuccess = '<h4 class="devlySavedSuccess"><img src="'. THEME_URI .'/assets/img/ui/success.png" /> ';
